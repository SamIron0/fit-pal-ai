              ...
              <div >
                ...
                <div className="relative  ">
                  <input
                    ...
                    className="bg-black placeholder-left-5 rounded-md h-16 pt-2 text-gray-200 w-10/12 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
