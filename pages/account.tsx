        ...
        <div className="sm:flex px-4 sm:flex-col sm:align-center">
          <div className="border border-zinc-700	max-w-3xl w-full rounded-md m-auto mt-3">
            ...
            <div className="border-t h-128 border-zinc-700 bg-zinc-900 text-zinc-500 rounded-b-md">
              ...
              <div >
                <div className="h-80 text-gray-200 pl-5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="bg-black rounded-md p-5 text-gray-200 w-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
